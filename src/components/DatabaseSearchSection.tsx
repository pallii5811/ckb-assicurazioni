    ...
    <div>
      ...
      <div className="flex flex-col sm:flex-row gap-2 mb-4">
        <div className="flex-1 relative">
          ...
          <input
            ...
            placeholder="Ruolo o settore (es. commercialista, avvocato, ristoratore...)"
      ...
      {!searched && (
        <div className="flex flex-wrap gap-2 mb-4">
          {[
            ...
            <button
              key={s.label}
              onClick={() => { setQuery(s.q); setLocation(s.l); }}
          ...
          <p className="text-sm text-slate-600">
            ...
            {sources.length > 0 && (
              <span className="ml-2 text-xs text-slate-400">
                da {Array.from(new Set(sources.map(formatVisibleSource))).join(' + ')}
              </span>
            )}
          </p>
        </div>
      ...
      {loading && results.length === 0 && (
        <div className="flex flex-col items-center py-12">
          ...
          <p className="text-sm text-slate-600 font-medium">Ricerca in corso su fonti professionali verificate...</p>
      ...
      {!searched && (
        <div className="flex flex-col items-center py-12 text-center">
          ...
          <h3 className="text-lg font-bold text-slate-800 mb-2">Ricerca Referenti e Professionisti</h3>
          <p className="text-sm text-slate-500 max-w-md mb-1">
            Cerca per <strong>ruolo/settore</strong> + <strong>città</strong> e ottieni subito tutti i dati:
          </p>
