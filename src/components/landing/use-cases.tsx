...
const useCases = [
  {
    ...
    query: '"aziende metalmeccaniche Lombardia verifica RC prodotti"',
    problem: 'Ore perse a cercare prospect senza priorità chiare',
    solution: 'Analisi automatica: vedi subito quali aree assicurative verificare per ogni azienda.',
    result: '+€12.000',
    period: '/mese',
  ...
  },
  {
    ...
    query: '"trasportatori Veneto fatturato > 1M verifica D&O"',
    problem: 'Chiamate a freddo senza sapere cosa proporre',
    solution: 'Profilo completo: ATECO, fatturato, dipendenti e aree assicurative da verificare. Proposta mirata.',
    result: '+€18.000',
    period: '/mese',
  ...
  },
  {
    ...
    problem: 'Non sai quali aziende hanno trigger consulenziali prioritari',
    solution: 'Priorità per settore e territorio. Chiami prima i prospect con verifiche più rilevanti.',
    result: '+€8.500',
    period: '/mese',
  ...
  },
  {
    ...
    query: '"aziende Emilia > 50 dipendenti verifica welfare"',
  ...
  },
  {
    icon: Users,
    title: 'Sub-Agente',
    query: '"ristoranti Roma verifica RC terzi"',
