...
export const metadata: Metadata = {
  title: 'Privacy Policy | CKB Assicurazione',
  description: 'Informativa sulla privacy di CKB Assicurazione ai sensi del GDPR e del D.Lgs. 196/2003.',
}
      ...
      <main className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="prose prose-slate max-w-none space-y-8 text-slate-700 text-[15px] leading-relaxed">
          <section>
            ...
            <p>
              Il Titolare del trattamento dei dati personali è <strong>CKB Assicurazione</strong> (di seguito &quot;Titolare&quot;),
              contattabile all&apos;indirizzo email: <a href="mailto:privacy@ckbassicurazione.it" className="text-violet-600 hover:underline">privacy@ckbassicurazione.it</a>.
            </p>
          </section>
